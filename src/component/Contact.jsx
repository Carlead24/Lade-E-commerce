            ...
            <div className="container mb-5">
                ...
                <div className="row">
                    <div className="col-md 5 d-flex justify-content-center">
                        <img src="/assets/contact3.png" alt="Contact Us" height="350px" width="350px" />
                    </div>
                    <div className="col-md-6">
                        <form >
                            <div class="mb-3">
                                <label for="exampleForm" class="form-label">Full Name</label>
                                <input type="text" class="form-control" id="exampleForm" placeholder="Ugochi Light Ibeh"/>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-outline-dark">Send Feedback</button>
                        </form>
                        </div>
                    </div>
                </div>
